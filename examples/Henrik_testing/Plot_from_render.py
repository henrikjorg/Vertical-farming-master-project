...
df = pd.read_csv('render/csv/171124-1736_simulation.csv')
...
climate_plot_path = os.path.join(output_folder, "plot_climate_figure.png")
crop_plot_path = os.path.join(output_folder, "plot_crop_figure.png")
control_input_plot_path = os.path.join(output_folder, "plot_control_input_figure.png")
Qs_plot_path = os.path.join(output_folder, "plot_Qs.png")
Phis_plot_path = os.path.join(output_folder, "plot_Phis.png")

plt.figure(1)
plt.savefig(climate_plot_path)

plt.figure(2)
plt.savefig(crop_plot_path)

plt.figure(3)
plt.savefig(control_input_plot_path)

plt.figure(4)
plt.savefig(Qs_plot_path)

plt.figure(5)
plt.savefig(Phis_plot_path)
