...
class Model:
    ...
    def model(self, t, y, climate, control_input):
        ...
        # Update models
        env_derivatives = self.env_model.env_conditions(env_state, crop_state, climate, control_input)
        plant_derivatives = self.crop_model.crop_conditions(env_state, crop_state,climate, control_input)
